...
1. Download Kaggle API (Check [reproducibility.md](https://github.com/Adityagurung/the-football-pundits/blob/main/README.md#Reproducibility) for instructions regarding building conda environment `e2e-data-pipeline`)
```bash
